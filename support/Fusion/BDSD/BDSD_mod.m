...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function I_Fus_BDSD = BDSD_mod(I_MS,I_PAN,ratio,S,GNyq_PAN,GNyq_MS,start_pos)
...
if nargin<=6 || isempty(start_pos), start_pos=[ceil(ratio/2),ceil(ratio/2)]; end
...
pan_LP_d = pan_LP(start_pos(1):ratio:end,start_pos(2):ratio:end);
