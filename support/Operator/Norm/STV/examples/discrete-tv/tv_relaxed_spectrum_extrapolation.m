%%     Discrete Total Variation based relaxed spectrum extrapolation
% 
...
solver_tv_relax(u0,lambda,A,adj_A,L_A,niter,'init',init,'verbose',true,'video',true); 

% display only a particular region-of-interest
crop_roi = @(u)u(50:200,50:200); 
solver_tv_relax(u0,lambda,A,adj_A,L_A,niter,'init',init,'verbose',true,'video',true,'displayFcn',crop_roi); 
