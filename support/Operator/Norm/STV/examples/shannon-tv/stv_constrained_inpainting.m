%%       Shannon Total Variation based image inpainting
% 
...
solver_stv_constr(nx,ny,n,proj_constr,niter,'gain',gain,'verbose',true,'video',true); 

% display only a particular region-of-interest
crop_roi = @(u)u(100+(1:200),100+(1:200)); 
solver_stv_constr(nx,ny,n,proj_constr,niter,'gain',gain,'verbose',true,'video',true,'displayFcn',crop_roi); 
...
solver_stv_constr(nx,ny,n,proj_constr,niter,'gain',gain,'verbose',true,'video',true,'displayFcn',logdft); 
...
solver_stv_constr(nx,ny,n,proj_constr,niter,'gain',gain,'verbose',true,'video',true,'displayFcn',displayFcn); 
