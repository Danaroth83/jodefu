%%         Shannon Total Variation based image zooming
% 
...
[u,E] = solver_stv_constr(nx,ny,n,proj_constr,niter,'verbose',verbose,'video',video); 
...
solver_stv_constr(nx,ny,n,proj_constr,niter,'verbose',verbose,'video',video); 

% display only a particular region-of-interest
crop_roi = @(u)u(100:220,100:270); 
solver_stv_constr(nx,ny,n,proj_constr,niter,'verbose',verbose,'video',video,'displayFcn',crop_roi);
...
solver_stv_constr(nx,ny,n,proj_constr,niter,'verbose',verbose,'video',video,'displayFcn',logdft); 
...
solver_stv_constr(nx,ny,n,proj_constr,niter,'verbose',verbose,'video',video,'displayFcn',displayFcn); 
