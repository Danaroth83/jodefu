...
if size(ImageToView,1)*size(ImageToView,2)>1250^2
    scaling=ceil(size(ImageToView,1)*size(ImageToView,2)/1250^2);
    ImageToView=imresize(ImageToView,1/scaling);
    fprintf('Image was resized by a factor of %d to show\n',scaling);
end
