...
%           Q2n_index:          Q2n index.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [Q_index, SAM_index, ERGAS_index, sCC, Q2n_index,Q2n_alt] = indexes_evaluation_mod(I_F,I_GT,ratio,L,Q_blocks_size,flag_cut_bounds,dim_cut,th_values)
...
sCC = SCC(I_GT, I_F,'laplacian','global1');
cd ..

if nargin==6
    cd Quality_Indices_HS/Q2n_new
    Q2n_alt=Q2n_picone(I_F,I_GT,Q_blocks_size,1,0);
    cd ..
    cd ..
end
