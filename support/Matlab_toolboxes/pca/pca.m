...
[n, p] = size(x);
is_checkSupportedNumeric('X',x,false,false,true); % complex is accepted here
...
if is_isString(vVariableWeights)
    WeightsNames = {'variance'};
    getParamVal(vVariableWeights,WeightsNames,...
        '''VariableWeights''');
