function [err,fig] = lf_errargt(ndfct,var,type,flagWin) %#ok<INUSD>
...
if err == 1
    ...
    % g1453261
    ToolNames = {'dw1dtool.m','wp1dtool.m','cw1dtool.m','cwimtool.m',...   
    'dw2dtool.m', 'wp2dtool.m', 'wvdtool.m', 'wpdtool.m', 'sw1dtool.m',...
    'de1dtool.m','re1dtool.m','cf1dtool.m','sw2dtool.m','cf2dtool.m',...
    'sigxtool.m','imgxtool.m','wfbmtool.m','wfustool.m','nwavtool.m',...
    'wmspcatool.m','wmuldentool.m','mdw1dtool.m','wc2dtool.m','dw3dtool.m',...
    'cwtfttool.m','wmp1dtool.m','cwtfttool2.m'};
