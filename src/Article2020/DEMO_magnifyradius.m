...
ratio=2;
% inversion='TV';
Nbiter=100; tol=0; % Nbiter=500; tol=10E-06;
...
sim_string=0; SNR=[]; preproc='hism';
testtype='default'; ra=1.30001; lambda_v=logspace(-3,-2,5); ra=1.5; ra=1.4; % ra=[];
% testtype='msonly';   ra=1.5; lambda_v=logspace(-3.5,-2.5,5); % Note: This setup is completely deterministic as no noise is added. This means that low lambda should work the best as the function is fully invertible
% % testtype='nodegrad'; lambda_v=logspace(-3,-2,5);
% % testtype='nomask'; lambda_v=logspace(-3.5,-2.5,5); ra=[]; % ra not used in this scenario

%% Simulated dataset

% sim_string=1; SNR=25; preproc='hism';
% testtype='default';  ra=1.30001; lambda_v=logspace(-3,-2,5); % ra=[];
