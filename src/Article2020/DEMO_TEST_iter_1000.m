...
output_folder = 'article_2020_bands';
Tests_image_formation = 2; % 1=CASSI, 2= MRCA
Tests_direct_model = 2; % 0 = Fusion, 1 = Mosaic+Fusion, 2=Mosaic+Fusion+d_b
Tests_image_regularization = 4; % 1 = l221, 4 =S1l1 UTV
Tests_image = 8; % Washington (4 bands)
lambda_v = 0.002;
