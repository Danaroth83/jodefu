function [PanSharpenedImage, Coeff] = HPM_local(I_MS,I_PAN,I_LP,S,equaliz,interp)
% Similar to GS_local, but with equalization with respect to I_MS
% Same results since equalization does not affect GS algorithms
%
% S can be:
...
% Equalization PAN with I_MS (differently from GS)
% keyboard
switch equaliz
    case 1
        for ii = 1:Bands,
