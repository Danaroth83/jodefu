function green =  green_interpolation(mosaic,mask,pattern,sigma,eps,DynamicRange)
% mask
imask = (mask == 0);
...
% clip 
tentativeGrh = clip(tentativeGrh,0,DynamicRange);
tentativeGrv = clip(tentativeGrv,0,DynamicRange);
tentativeGbh = clip(tentativeGbh,0,DynamicRange);
tentativeGbv = clip(tentativeGbv,0,DynamicRange);
tentativeRh = clip(tentativeRh,0,DynamicRange);
tentativeRv = clip(tentativeRv,0,DynamicRange);
tentativeBh = clip(tentativeBh,0,DynamicRange);
tentativeBv = clip(tentativeBv,0,DynamicRange);
...
% clip
Grh = clip(Grh,0,DynamicRange);
Grv = clip(Grv,0,DynamicRange);
Gbh = clip(Gbh,0,DynamicRange);
Gbv = clip(Gbv,0,DynamicRange);
Rh = clip(Rh,0,DynamicRange);
Rv = clip(Rv,0,DynamicRange);
Bh = clip(Bh,0,DynamicRange);
Bv = clip(Bv,0,DynamicRange);
